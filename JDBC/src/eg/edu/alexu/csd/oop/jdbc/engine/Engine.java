...
public class Engine {
  ...
  public Engine(String homePath) {
    ...
    selectionQueryCarrier = SelectionQueryCarrier.getInst();
    updateQueryCarrier = UpdateQueryCarrier.getInst();
    deletionQueryCarrier = DeletionQueryCarrier.getInst();
    insertionQueryCarrier = InsertionQueryCarrier.getInst();
  }
